...
INSERT INTO user (username, password, email, enabled, create_time, update_time) VALUES
...
-- 角色
INSERT INTO role (name, code, description, create_time) VALUES
...
-- 菜单数据 (按照设计层级)
INSERT INTO menu (menu_name, parent_id, path, component, icon, sort_order, permission, type, status, create_time) VALUES
-- 系统管理 (parent_id=0)
